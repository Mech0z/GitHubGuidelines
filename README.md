...
When writing the subject the total length including type and PR information, should be 50 characters or less, this is to ensure easy readability in all Git Clients, see [this](https://www.midori-global.com/blog/2018/04/02/git-50-72-rule) for reference following format.
